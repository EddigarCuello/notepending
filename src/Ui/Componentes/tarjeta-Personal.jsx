                ...
                {editMode ? (
                    <>
                        <input
                            ...
                            className={`w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 mb-2 ${idProyecto !== null ? 'cursor-not-allowed' : ''}`}
                            disabled={idProyecto !== null}
                        />
                        <textarea
                            value={descripcion}
                            onChange={e => setDescripcion(e.target.value)}
                            className={`w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 mb-2 h-24 ${idProyecto !== null ? 'cursor-not-allowed' : ''}`}
                            disabled={idProyecto !== null}
                        />
                        ...
                        <div className="flex items-center mb-2">
                            <label className="text-gray-500 text-sm mr-2">Entregado:</label>
                            <input
                                type="checkbox"
                                checked={entregado}
                                onChange={handleEntregadoChange}
                                className="text-gray-500 bg-gray-200 rounded"
                            />
                        </div>
                        <div className="flex flex-col mb-2">
                            <label className="text-gray-500 text-sm">Subir Archivo:</label>
                            <input
                                type="file"
                        ...
                        <div className="flex justify-end gap-2">
                            ...
                            <button className="bg-gray-500 text-white px-4 py-2 rounded" onClick={() => setEditMode(false)}>Cancelar</button>
                        </div>
                    </>
                ) : (
                    <>
                        ...
                        <div className="flex justify-center gap-2 mb-2 break-words whitespace-pre-wrap">
                            ...
                            <button
                                className={`bg-red-500 text-white px-9 py-2 rounded break-words whitespace-pre-wrap ${idProyecto !== null ? 'cursor-not-allowed opacity-50' : ''}`}
